            ...
            <div class="tile is-parent is-vertical">
              <article class="tile is-child notification is-primary">
                <p class="subtitle intro left">
                  Ivan attends Willow School of New Orleans and
                  School of Rock Metairie. He is a fan of the Pelicans, Saints and bad movies.
                  <br /><br />
          ...
          <div class="tile">
            <article class="tile is-child notification is-success">
              <div class="content">
                ...
                <p class="subtitle mt-5">Minecraft</p>
...
@import url('https://fonts.googleapis.com/css2?family=Caveat&display=swap');
  .hello {
    ...
    background: linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)),
      url(https://media.giphy.com/media/0p9qsycroA7m41l34b/giphy.gif);
