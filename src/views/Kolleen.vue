          ...
          <div class="tile">
            <div class="tile is-parent is-vertical">
              ...
              <article class="tile is-child notification is-warning">
                ...
                <p class="subtitle">
                  <a class="button is-medium is-text" href='http://www.zazzle.com/gifts?ch=strivedesigns' target="_blank">Zazzle</a>

                  <a class="button is-medium is-text" href='http://www.spoonflower.com/profiles/strive' target="_blank">Spoonflower</a>
                </p>
              </article>
            </div>
...
>>>>>>> 81345a7acf6a0e836f58130f6b4f53f342d7d4b4
        ...
        <div class="tile is-parent">
          <article class="tile is-child notification is-success">
            <div class="content">
              <p class="title" style="padding-bottom:10px">Things I Like</p>
              <p class="subtitle ">Yarn</p>
              <p class="subtitle"> Peppermint</p>
              <p class="subtitle"> Ed Emberley</p>
              <p class="subtitle"> Polka Dots</p>
              <p class="subtitle"> Felt Tip Pens</p>
              <p class="subtitle"> Smell of Rain</p>
              <p class="subtitle"> Square Necklines</p>
              <p class="subtitle"> Macaroni and Cheese</p>
              <div class="content">
      ...
      <div class="field is-grouped">
        ...
        <p class="control">
          <router-link class="button is-text" to="/ben">Ben</router-link>
